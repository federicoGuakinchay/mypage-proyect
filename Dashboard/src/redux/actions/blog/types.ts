...
export const GET_AUTHOR_BLOG_LIST_SUCCESS = 'GET_AUTH_BLOG_LIST_SUCCESS' ;
export const GET_AUTHOR_BLOG_LIST_FAIL =    'GET_AUTH_BLOG_LIST_FAIL' ;
...
export const GET_BLOG_SEARCH_SUCCESS = 'GET_BLOG_SEARCH_SUCCESS' ;
export const GET_BLOG_SEARCH_FAIL = 'GET_BLOG_SEARCH_FAIL' ;