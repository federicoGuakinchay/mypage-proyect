...
const RouteName:React.FC = () => {
  ...
  switch (true){
    case location_name.startsWith('/home'):
      return (
      <h1 className="w-full text-3xl text-left mb-[1%]  font-semibold flex items-center">
      <TiHomeOutline/>{location_name.substring(5)}/</h1>)
    case location_name.startsWith('/calendar'):
      return (<h1 className="w-full text-3xl text-left mb-[1%]  font-semibold flex items-center">
    ...
    case location_name.startsWith('/my_porfile'):
      return (<h1 className="w-full text-3xl text-left mb-[1%]  font-semibold flex items-center">
        <CgProfile/>{location_name.substring(11)}/</h1>)
    default: return (<h1 className="w-full text-3xl text-left mb-[1%]  font-semibold flex items-center">
      {location_name}/</h1>)
  }
}
